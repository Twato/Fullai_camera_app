...
tk.Button(input_card, text="START TEST", font=("Arial", 18, "bold"), bg=BLUE, fg="white", activebackground=BLUE_DARK, activeforeground="white", relief="flat", command=start_job).pack(fill="x", ipady=10, pady=(4, 8))
tk.Button(input_card, text="EXIT APP", font=("Arial", 18, "bold"), bg=RED, fg="white", activebackground=RED_DARK, activeforeground="white", relief="flat", command=exit_app).pack(fill="x", ipady=10)
