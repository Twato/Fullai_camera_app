...
def title_with_icon(parent, icon_key, text, bg=CARD):
    ...
    tk.Label(frame, text=text, bg=bg, fg=TEXT, font=("Arial", 18, "bold")).pack(side="left")
    return frame
...
tk.Button(input_card, text="EXIT APP", font=("Arial", 18, "bold"), bg=RED, fg="white", activebackground=RED_DARK, activeforeground="white", relief="flat", command=exit_app).pack(fill="x", ipady=9)
...
# Section 1 header
header_frame = tk.Frame(capture_container, bg=CARD, highlightbackground=BORDER, highlightthickness=1, padx=22, pady=18)
...
info_row1.pack(fill="x", pady=(0, 12))
...
inner_box_container.pack(side="left", padx=(0, 60))
...
info_box_title = tk.Label(info_box_text, text="Inner Box", bg=CARD, fg=MUTED, font=("Arial", 13, "bold"), anchor="w")
info_box_title.pack(anchor="w")
info_box = tk.Label(info_box_text, text="-", bg=CARD, fg=TEXT, font=("Arial", 20, "bold"), width=10, anchor="w")
info_box.pack(anchor="w", pady=(3, 0))
...
progress_title_label = tk.Label(product_header, text="Inner Box", bg=CARD, fg=TEXT, font=("Arial", 14, "bold"))
progress_title_label.pack(side="left")

product_row = tk.Frame(capture_right, bg=CARD)
product_row.pack(fill="x")
progress_label = tk.Label(product_row, text="0 / 0", bg=CARD, fg=TEXT, font=("Arial", 15, "bold"))
progress_label.pack(side="left")
progress_percent_label = tk.Label(product_row, text="0%", bg=CARD, fg=TEXT, font=("Arial", 13, "bold"))
...
tk.Label(check_header, text="Checklist", bg=CARD, fg=TEXT, font=("Arial", 14, "bold")).pack(side="left")
...
tk.Label(step_header, text="Step", bg=SOFT, fg="#34495e", font=("Arial", 12, "bold")).pack(side="left")
...
tk.Label(status_detail_header, text="Status", bg=SOFT, fg="#34495e", font=("Arial", 12, "bold")).pack(side="left")
