...
def title_with_icon(parent, icon_key, text, bg=CARD):
    ...
    tk.Label(frame, text=text, bg=bg, fg=TEXT, font=("Arial", 20, "bold")).pack(side="left")
    return frame
...
# Section 1 header
header_frame = tk.Frame(capture_container, bg=CARD, highlightbackground=BORDER, highlightthickness=1, padx=26, pady=30)
...
add_action_button(header_buttons, "Restart The Process", bg="#bfc3c7", fg=TEXT, command=restart_process, width_px=205, height_px=52)
add_action_button(header_buttons, "Cancel Job", bg=RED, fg="white", command=cancel_job, width_px=205, height_px=52)
add_action_button(header_buttons, "OK / NEXT", bg="#27ae60", fg="white", command=on_result_ok, width_px=205, height_px=52)

info_row1 = tk.Frame(info_left, bg=CARD)
info_row1.pack(fill="x", pady=(0, 24))
...
info_box_title = tk.Label(info_box_text, text="Inner Box", bg=CARD, fg=MUTED, font=("Arial", 18, "bold"), anchor="w")
info_box_title.pack(anchor="w")
info_box = tk.Label(info_box_text, text="-", bg=CARD, fg=TEXT, font=("Arial", 23, "bold"), width=10, anchor="w")
...
tk.Label(capture_left, text="Preview", bg=CARD, fg=MUTED, font=("Arial", 13, "bold")).pack(anchor="w", pady=(8, 4))
...
progress_title_label = tk.Label(product_header, text="Inner Box", bg=CARD, fg=TEXT, font=("Arial", 16, "bold"))
progress_title_label.pack(side="left")

product_row = tk.Frame(capture_right, bg=CARD)
product_row.pack(fill="x")
progress_label = tk.Label(product_row, text="0 / 0", bg=CARD, fg=TEXT, font=("Arial", 17, "bold"))
progress_label.pack(side="left")
progress_percent_label = tk.Label(product_row, text="0%", bg=CARD, fg=TEXT, font=("Arial", 15, "bold"))
...
cancel_result_btn = add_action_button(result_button_frame, "Cancel Job", bg=RED, fg="white", command=cancel_job, width_px=205, height_px=52, frame_bg=BG)
restart_result_btn = add_action_button(result_button_frame, "Restart The Process", bg="#bfc3c7", fg=TEXT, command=restart_process, width_px=205, height_px=52, frame_bg=BG)
ok_next_btn = add_action_button(result_button_frame, "OK / NEXT", bg="#27ae60", fg="white", command=on_result_ok, width_px=205, height_px=52, frame_bg=BG)
