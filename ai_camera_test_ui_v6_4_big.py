...
def title_with_icon(parent, icon_key, text, bg=CARD):
    ...
    tk.Label(frame, text=text, bg=bg, fg=TEXT, font=("Arial", 16, "bold")).pack(side="left")
    return frame
...
input_card.place(relx=0.5, rely=0.50, anchor="center", width=760, height=640)

tk.Label(input_card, text="Start Test Job", font=("Arial", 30, "bold"), bg=CARD, fg=TEXT).pack(anchor="w", pady=(0, 24))
...
tk.Button(input_card, text="START TEST", font=("Arial", 18, "bold"), bg=BLUE, fg="white", activebackground=BLUE_DARK, activeforeground="white", relief="flat", command=start_job).pack(fill="x", ipady=12, pady=(6, 14))
tk.Button(input_card, text="EXIT APP", font=("Arial", 18, "bold"), bg=RED, fg="white", activebackground=RED_DARK, activeforeground="white", relief="flat", command=exit_app).pack(fill="x", ipady=12)
...
# Section 1 header
header_frame = tk.Frame(capture_container, bg=CARD, highlightbackground=BORDER, highlightthickness=1, padx=18, pady=12)
...
add_action_button(header_buttons, "Restart The Process", bg="#bfc3c7", fg=TEXT, command=restart_process, width_px=190, height_px=44)
add_action_button(header_buttons, "Cancel Job", bg=RED, fg="white", command=cancel_job, width_px=190, height_px=44)
add_action_button(header_buttons, "OK / NEXT", bg="#27ae60", fg="white", command=on_result_ok, width_px=190, height_px=44)
...
progress_bar_bg = tk.Frame(capture_right, bg="#c4c4c8", height=22)
...
cancel_result_btn = add_action_button(result_button_frame, "Cancel Job", bg=RED, fg="white", command=cancel_job, width_px=190, height_px=44, frame_bg=BG)
restart_result_btn = add_action_button(result_button_frame, "Restart The Process", bg="#bfc3c7", fg=TEXT, command=restart_process, width_px=190, height_px=44, frame_bg=BG)
ok_next_btn = add_action_button(result_button_frame, "OK / NEXT", bg="#27ae60", fg="white", command=on_result_ok, width_px=190, height_px=44, frame_bg=BG)
