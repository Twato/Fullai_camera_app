...
# =========================================================
# STORAGE RETENTION / CLEANUP LOG (T20)
# Auto-delete data older than 90 days and keep cleanup evidence.
# Log folder:
...
def auto_delete_old_storage(retention_days=RETENTION_DAYS):
    """
    T20: Delete YYYY/MM/DD storage folders older than retention_days.
    ...
    log_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "version": "T20_STORAGE_RETENTION_90_DAYS",
                    ...
                    if folder_date < cutoff:
                        try:
                            ...
                            log_data["deleted"].append({
                                ...
                                "reason": f"older_than_{int(retention_days)}_days",
                                "deleted_at": now_iso(),
                            })
...
def init_job_data():
    ...
    job_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "design_version": "T20_STORAGE_RETENTION_90_DAYS",
...
def startup_preload_worker():
    ...
    try:
        deleted = auto_delete_old_storage(retention_days=90)
        set_preload_status(detail=f"Auto-delete done. Deleted {len(deleted)} old day folder(s). Cleanup log saved.", cleanup="OK")
    except Exception as e:
...
# =========================================================
root = tk.Tk()
root.title("AI Camera Station - YOLO ROI OCR - T20")
