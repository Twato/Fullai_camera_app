...
# =========================================================
APP_VERSION = "T27_USB_REDISCOVERY_RECOVERY"
...
def auto_delete_old_storage(retention_days=None):
    ...
    log_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "version": "T27_USB_REDISCOVERY_RECOVERY",
...
def init_job_data():
    ...
    job_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "design_version": "T27_USB_REDISCOVERY_RECOVERY",
...
root.title("AI Camera Station - YOLO ROI OCR - T27")
