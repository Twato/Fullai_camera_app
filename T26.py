...
# =========================================================
APP_VERSION = "T26_CAMERA_FAIL_WAIT_OPERATOR"
...
try:
    ...
    print("T26 Pi camera threshold applied:",
...
def auto_delete_old_storage(retention_days=None):
    ...
    log_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "version": "T26_CAMERA_FAIL_WAIT_OPERATOR",
...
def init_job_data():
    ...
    job_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "design_version": "T26_CAMERA_FAIL_WAIT_OPERATOR",
...
def schedule_storage_cleanup():
    ...
    def run_cleanup_worker():
        ...
        try:
            print("=" * 60)
            print("T26 DAILY STORAGE CLEANUP START", now_iso())
            deleted = auto_delete_old_storage()
            print(f"T26 DAILY STORAGE CLEANUP DONE. Deleted {len(deleted)} day folder(s).")
            print("=" * 60)
            try:
            ...
            print("T26 DAILY STORAGE CLEANUP ERROR:", e)
            try:
...
root.title("AI Camera Station - YOLO ROI OCR - T26")
