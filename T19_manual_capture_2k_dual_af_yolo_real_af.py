...
def capture_pi_stage():
    ...
    try:
        ...
        set_status(
            f"CAM1 + CAM2 real autofocus together... CAM1 {PICAM1_FOCUS_DELAY_SEC:.1f}s / CAM2 {PICAM2_FOCUS_DELAY_SEC:.1f}s",
            BLUE,
        )
        ...
        th1.join()
        th2.join()
        print(f"CAM1+CAM2 T19 real-AF parallel AF/capture total: {time.time() - t_all:.2f}s")
