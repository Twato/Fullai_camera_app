...
try:
    ...
    print("T23 Pi camera threshold applied:",
...
def auto_delete_old_storage(retention_days=None):
    ...
    log_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "version": "T23_RESET_CAMERA_THRESHOLD",
...
def init_job_data():
    ...
    job_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "design_version": "T23_RESET_CAMERA_THRESHOLD",
...
def reset_current_camera():
    """T23: Reset only the currently active camera/stage without cancelling the job.
...
def schedule_storage_cleanup():
    ...
    def run_cleanup_worker():
        ...
        try:
            print("=" * 60)
            print("T23 DAILY STORAGE CLEANUP START", now_iso())
            deleted = auto_delete_old_storage()
            print(f"T23 DAILY STORAGE CLEANUP DONE. Deleted {len(deleted)} day folder(s).")
            print("=" * 60)
            try:
            ...
            print("T23 DAILY STORAGE CLEANUP ERROR:", e)
            try:
...
# =========================================================
root = tk.Tk()
root.title("AI Camera Station - YOLO ROI OCR - T23")
